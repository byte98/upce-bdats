...
public class XMLFormatter
{
    ...
    /**
     * Formats actual location to XML style string
     * @param loc Actual location
     * @param indent Actual level of indentation
     * @return String in XML format containing actual location
     */
    public String formatActual(Location loc, int indent)
    {
        StringBuilder reti = new StringBuilder();
        reti.append(this.indent(indent)).append("<").append(XMLFormat.XML_ACTUAL_LOCATION).append(">").append(System.lineSeparator())
            .append(this.formatLocation(loc, indent + 1))
            .append(this.indent(indent)).append("</").append(XMLFormat.XML_ACTUAL_LOCATION).append(">").append(System.lineSeparator());
        return reti.toString();
    }
}
