...
public class Zamek
{
    ...
    public String toString()
    {
        ...
        if (Double.isNaN(Distance.getDistance(this.location)) == false)
        {
            byte[] rulerIcon = new byte[]{(byte)0xf0, (byte)0x9f, (byte)0x93, (byte)0x8f};
            reti.append(", ");
            reti.append(new String(rulerIcon, Charset.forName("UTF-8")));
            reti.append(" VZDALENOST: ");
            reti.append(String.format("%.2f km", Distance.getDistance(this.location) / 1000));
        }
